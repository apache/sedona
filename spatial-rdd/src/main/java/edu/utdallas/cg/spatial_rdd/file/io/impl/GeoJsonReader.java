...
package edu.utdallas.cg.spatial_rdd.file.io.impl;

import edu.utdallas.cg.spatial_rdd.core.rdd.SpatialRDD;
import edu.utdallas.cg.spatial_rdd.file.io.RddReader;
import edu.utdallas.cg.spatial_rdd.enums.FileDataSplitter;
import edu.utdallas.cg.spatial_rdd.file.parser.FormatMapper;
...
public class GeoJsonReader extends RddReader {
  ...
  public static SpatialRDD<Geometry> readToGeometryRDD(
    ...
    FormatMapper<Geometry> formatMapper = new FormatMapper<>(FileDataSplitter.GEOJSON, true);
