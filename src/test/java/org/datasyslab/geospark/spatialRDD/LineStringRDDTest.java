...
public class LineStringRDDTest {
    ...
    public static void onceExecutedBeforeAll() {
        SparkConf conf = new SparkConf().setAppName("LineStringTest").setMaster("local[2]");
        sc = new JavaSparkContext(conf);
        Logger.getLogger("org").setLevel(Level.WARN);
        Logger.getLogger("akka").setLevel(Level.WARN);
        prop = new Properties();
        input = LineStringRDDTest.class.getClassLoader().getResourceAsStream("linestring.test.properties");
        ...
        try {
            ...
            InputLocation = "file://"+LineStringRDDTest.class.getClassLoader().getResource(prop.getProperty("inputLocation")).getPath();
