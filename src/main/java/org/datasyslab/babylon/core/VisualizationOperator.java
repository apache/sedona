...
public abstract class VisualizationOperator implements Serializable{
	...
	protected JavaPairRDD<Integer, Long> Rasterize(JavaSparkContext sparkContext, 
		...
		JavaPairRDD<Integer, Long> spatialRDDwithPixelId = rawSpatialRDD.flatMapToPair(new PairFlatMapFunction<Object,Integer,Long>()
		{
			...
			@Override
			public Iterable<Tuple2<Integer, Long>> call(Object spatialObject) throws Exception {
	...
	protected JavaPairRDD<Integer, Long> Rasterize(JavaSparkContext sparkContext, 
		...
		{
			@Override
			public Iterable<Tuple2<Integer, Long>> call(Tuple2 spatialObject) throws Exception {
				if(spatialObject._1 instanceof Envelope)
				{
					return RasterizationUtils.FindPixelCoordinates(resolutionX,resolutionY,datasetBoundary,(Envelope)spatialObject._1(),reverseSpatialCoordinate,(Long)spatialObject._2());
