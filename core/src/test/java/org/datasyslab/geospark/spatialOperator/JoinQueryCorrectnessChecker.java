/**
 * FILE: JoinQueryCorrectnessChecker.java
 * PATH: org.datasyslab.geospark.spatialOperator.JoinQueryCorrectnessChecker.java
...
class PointByPolygonSortComparator implements Comparator<Tuple2<Polygon,HashSet<Point>>>, Serializable
{
...
class PolygonByPolygonSortComparator implements Comparator<Tuple2<Polygon,HashSet<Polygon>>>, Serializable
{
...
public class JoinQueryCorrectnessChecker {
	 ...
	 */
	@Test
	public void testInsidePointJoinCorrectnessUsingQuadTreePartitioning() throws Exception{
		PolygonRDD windowRDD = new PolygonRDD(sc.parallelize(this.testPolygonWindowSet),StorageLevel.MEMORY_ONLY());
		PointRDD objectRDD = new PointRDD(sc.parallelize(this.testInsidePointSet),StorageLevel.MEMORY_ONLY());
		objectRDD.rawSpatialRDD.repartition(4);
	 ...
	 */
	@Test
	public void testOnBoundaryPointJoinCorrectnessUsingQuadTreePartitioning() throws Exception{
		PolygonRDD windowRDD = new PolygonRDD(sc.parallelize(this.testPolygonWindowSet),StorageLevel.MEMORY_ONLY());
		PointRDD objectRDD = new PointRDD(sc.parallelize(this.testOnBoundaryPointSet),StorageLevel.MEMORY_ONLY());
		objectRDD.rawSpatialRDD.repartition(4);
		objectRDD.spatialPartitioning(GridType.QUADTREE);
	 ...
	 */
	@Test
	public void testOutsidePointJoinCorrectnessUsingQuadTreePartitioning() throws Exception{
		PolygonRDD windowRDD = new PolygonRDD(sc.parallelize(this.testPolygonWindowSet),StorageLevel.MEMORY_ONLY());
		PointRDD objectRDD = new PointRDD(sc.parallelize(this.testOutsidePointSet),StorageLevel.MEMORY_ONLY());
		objectRDD.rawSpatialRDD.repartition(4);
		objectRDD.spatialPartitioning(GridType.QUADTREE);
	 ...
	 */
	@Test
	public void testInsideLineStringJoinCorrectnessUsingQuadTreePartitioning() throws Exception{
		PolygonRDD windowRDD = new PolygonRDD(sc.parallelize(this.testPolygonWindowSet),StorageLevel.MEMORY_ONLY());
		LineStringRDD objectRDD = new LineStringRDD(sc.parallelize(this.testInsideLineStringSet),StorageLevel.MEMORY_ONLY());
		objectRDD.rawSpatialRDD.repartition(4);
		objectRDD.spatialPartitioning(GridType.QUADTREE);
	 ...
	 */
	@Test
	public void testOverlappedLineStringJoinCorrectnessUsingQuadTreePartitioning() throws Exception{
		PolygonRDD windowRDD = new PolygonRDD(sc.parallelize(this.testPolygonWindowSet),StorageLevel.MEMORY_ONLY());
		LineStringRDD objectRDD = new LineStringRDD(sc.parallelize(this.testOverlappedLineStringSet),StorageLevel.MEMORY_ONLY());
		objectRDD.rawSpatialRDD.repartition(4);
		objectRDD.spatialPartitioning(GridType.QUADTREE);
	 ...
	 */
	@Test
	public void testOutsideLineStringJoinCorrectnessUsingQuadTreePartitioning() throws Exception{
		PolygonRDD windowRDD = new PolygonRDD(sc.parallelize(this.testPolygonWindowSet),StorageLevel.MEMORY_ONLY());
		LineStringRDD objectRDD = new LineStringRDD(sc.parallelize(this.testOutsideLineStringSet),StorageLevel.MEMORY_ONLY());
		objectRDD.rawSpatialRDD.repartition(4);
		objectRDD.spatialPartitioning(GridType.QUADTREE);
	 ...
	 */
	@Test
	public void testInsidePolygonJoinCorrectnessUsingQuadTreePartitioning() throws Exception{
		PolygonRDD windowRDD = new PolygonRDD(sc.parallelize(this.testPolygonWindowSet),StorageLevel.MEMORY_ONLY());
		PolygonRDD objectRDD = new PolygonRDD(sc.parallelize(this.testInsidePolygonSet),StorageLevel.MEMORY_ONLY());
		objectRDD.rawSpatialRDD.repartition(4);
		objectRDD.spatialPartitioning(GridType.QUADTREE);
	 ...
	 */
	@Test
	public void testOverlappedPolygonJoinCorrectnessUsingQuadTreePartitioning() throws Exception{
		PolygonRDD windowRDD = new PolygonRDD(sc.parallelize(this.testPolygonWindowSet),StorageLevel.MEMORY_ONLY());
		PolygonRDD objectRDD = new PolygonRDD(sc.parallelize(this.testOverlappedPolygonSet),StorageLevel.MEMORY_ONLY());
		objectRDD.rawSpatialRDD.repartition(4);
		objectRDD.spatialPartitioning(GridType.QUADTREE);
	 ...
	 */
	@Test
	public void testOutsidePolygonJoinCorrectnessUsingQuadTreePartitioning() throws Exception{
		PolygonRDD windowRDD = new PolygonRDD(sc.parallelize(this.testPolygonWindowSet),StorageLevel.MEMORY_ONLY());
		PolygonRDD objectRDD = new PolygonRDD(sc.parallelize(this.testOutsidePolygonSet),StorageLevel.MEMORY_ONLY());
		objectRDD.rawSpatialRDD.repartition(4);
		objectRDD.spatialPartitioning(GridType.QUADTREE);
	 ...
	 */
	@Test
	public void testInsidePolygonDistanceJoinCorrectnessUsingQuadTreePartitioning() throws Exception{
		PolygonRDD centerGeometryRDD = new PolygonRDD(sc.parallelize(this.testPolygonWindowSet),StorageLevel.MEMORY_ONLY());
		CircleRDD windowRDD = new CircleRDD(centerGeometryRDD,0.1);
		PolygonRDD objectRDD = new PolygonRDD(sc.parallelize(this.testInsidePolygonSet),StorageLevel.MEMORY_ONLY());
		objectRDD.rawSpatialRDD.repartition(4);
	 ...
	 */
	@Test
	public void testOverlappedPolygonDistanceJoinCorrectnessUsingQuadTreePartitioning() throws Exception{
		PolygonRDD centerGeometryRDD = new PolygonRDD(sc.parallelize(this.testPolygonWindowSet),StorageLevel.MEMORY_ONLY());
		CircleRDD windowRDD = new CircleRDD(centerGeometryRDD,0.1);
		PolygonRDD objectRDD = new PolygonRDD(sc.parallelize(this.testOverlappedPolygonSet),StorageLevel.MEMORY_ONLY());
		objectRDD.rawSpatialRDD.repartition(4);
	 ...
	 */
	@Test
	public void testOutsidePolygonDistanceJoinCorrectnessUsingQuadTreePartitioning() throws Exception{
		PolygonRDD centerGeometryRDD = new PolygonRDD(sc.parallelize(this.testPolygonWindowSet),StorageLevel.MEMORY_ONLY());
		CircleRDD windowRDD = new CircleRDD(centerGeometryRDD,0.1);
		PolygonRDD objectRDD = new PolygonRDD(sc.parallelize(this.testOutsidePolygonSet),StorageLevel.MEMORY_ONLY());
		objectRDD.rawSpatialRDD.repartition(4);
