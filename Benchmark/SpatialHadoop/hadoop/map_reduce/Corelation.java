...
public class Corelation {
	...
	public Corelation(String hdfs, String inputRec1) {
	...
	public void run() throws IOException{
		...
		JobConf conf1 = new JobConf(Corelation.class);
		...
		JobConf conf2 = new JobConf(Corelation.class);
		...
		JobConf conf4 = new JobConf(Corelation.class);
		...
		JobConf conf5 = new JobConf(Corelation.class);
		...
		deletehdfsFile(hdfspath + "aggtemp");
		// Six Calculate Wij
		JobConf conf6 = new JobConf(Corelation.class);
...
//		System.out.println("[Measure]"+"I is " + I);
	...
	public static void main(String args[]) throws IOException {
		Corelation ac = new Corelation(args[0], args[1]);
		ac.run();
	}
}
