...
public class ColocationWithIndex {
	...
	ColocationWithIndex(String hdfspath, String inputRec1, String inputRec2, String Distance) {
	...
	public void run() throws IOException {
		...
		JobConf conf0 = new JobConf(ColocationWithIndex.class);
		...
		JobConf conf00 = new JobConf(ColocationWithIndex.class);
		...
		//Begin phase 1
		JobConf conf1 = new JobConf(ColocationWithIndex.class);
		...
		// 2;
		JobConf conf2 = new JobConf(ColocationWithIndex.class);
		...
		JobConf conf3 = new JobConf(ColocationWithIndex.class);
		...
		JobConf conf33 = new JobConf(ColocationWithIndex.class);
...
//		conf3.setMapperClass(MapForMax2.class);
		JobConf conf34 = new JobConf(ColocationWithIndex.class);
		...
		JobConf conf35 = new JobConf(ColocationWithIndex.class);
		...
		JobConf conf41 = new JobConf(ColocationWithIndex.class);
		...
		JobConf conf42 = new JobConf(ColocationWithIndex.class);
		...
		JobConf conf43 = new JobConf(ColocationWithIndex.class);
		...
		JobConf conf5 = new JobConf(ColocationWithIndex.class);
		...
		JobConf conf6 = new JobConf(ColocationWithIndex.class);
		...
		try {
			Process p = Runtime.getRuntime().exec("shadoop index " + "point1poly " +  "point1poly.index " + "sindex:rtree"
					+ "shape:wkt" + " -overwrite");
		...
		try {
			Process p = Runtime.getRuntime().exec("shadoop index " + "point2point " +  "point2point.index " + "sindex:rtree"
					+ "shape:wkt" + " -overwrite");
			InputStream stderr = p.getErrorStream();
			InputStream stdout = p.getInputStream();
            InputStreamReader isr = new InputStreamReader(stderr);
		...
		try {
			Process p = Runtime.getRuntime().exec("shadoop sjmr " + "point1poly.index " +  "point2point.index " + "polyjoinpoint "
					+ "shape:wkt" + " -overwrite");
			InputStream stderr = p.getErrorStream();
			InputStream stdout = p.getInputStream();
            InputStreamReader isr = new InputStreamReader(stderr);
		...
		// Filter
		// Based on point set 2, create a Point set.
		JobConf conf8 = new JobConf(ColocationWithIndex.class);
	...
	public static void main(String args[]) throws IOException {
		ColocationWithIndex colocation = new ColocationWithIndex(args[0], args[1], args[2], args[3]);
		//System.out.println("distance is " + Colocation.distance);
		colocation.run();
	}
}