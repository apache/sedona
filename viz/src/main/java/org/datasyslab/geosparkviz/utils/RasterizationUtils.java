        ...
        implements Serializable
{
     ...
     * @return the list
     */
    public static List<Tuple2<Pixel, Double>> FindPixelCoordinates(int resolutionX, int resolutionY, Envelope datasetBoundary, org.locationtech.jts.geom.Point spatialObject, ColorizeOption colorizeOption, boolean reverseSpatialCoordinate)
    {
     ...
     * @return the list
     */
    public static List<Tuple2<Pixel, Double>> FindPixelCoordinates(int resolutionX, int resolutionY, Envelope datasetBoundary, org.locationtech.jts.geom.Polygon spatialObject, boolean reverseSpatialCoordinate)
    {
        List<Tuple2<Pixel, Double>> result = new ArrayList<Tuple2<Pixel, Double>>();
     ...
     * @return the list
     */
    public static List<Tuple2<Pixel, Double>> FindPixelCoordinates(int resolutionX, int resolutionY, Envelope datasetBoundary, org.locationtech.jts.geom.LineString spatialObject, boolean reverseSpatialCoordinate)
    {
        List<Tuple2<Pixel, Double>> result = new ArrayList<Tuple2<Pixel, Double>>();
        for (int i = 0; i < spatialObject.getCoordinates().length - 1; i++) {
            Tuple2<Integer, Integer> pixelCoordinate1 = null;
