...
Data loaded in R can be copied to Spark using `copy_to`. Columns containing spatial information can be converted to the geometry type in Spark DataFrames (GeometryUDT) with Spark SQL functions such as `ST_GeomFromText` or `ST_GeomFromText`, see [Vector constructors](https://sedona.apache.org/latest-snapshot/api/sql/Constructor/) and [Raster input and output](https://sedona.apache.org/latest-snapshot/api/sql/Raster-loader/).
...
* [Vector functions](https://sedona.apache.org/latest-snapshot/api/sql/Function/)
* [Vector predicates](https://sedona.apache.org/latest-snapshot/api/sql/Predicate/)
* [Vector aggregate functions](https://sedona.apache.org/latest-snapshot/api/sql/AggregateFunction/)
* [Raster operators](https://sedona.apache.org/latest-snapshot/api/sql/Raster-operators/)
