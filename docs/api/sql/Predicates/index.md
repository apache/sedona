...
| :--- | :--- | :--- |
| [ST_Contains](ST_Contains.md) | Return true if A fully contains B | v1.0.0 |
...
| [ST_Crosses](ST_Crosses.md) | Return true if A crosses B | v1.0.0 |
...
| [ST_Equals](ST_Equals.md) | Return true if A equals to B | v1.0.0 |
| [ST_Intersects](ST_Intersects.md) | Return true if A intersects B | v1.0.0 |
...
| [ST_Overlaps](ST_Overlaps.md) | Return true if A overlaps B | v1.0.0 |
...
| [ST_Touches](ST_Touches.md) | Return true if A touches B | v1.0.0 |
| [ST_Within](ST_Within.md) | Return true if A is fully contained by B | v1.0.0 |
