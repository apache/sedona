...
Sedona 2.0 with Spark 4.1 requires `org.datasyslab:jts-core:1.21.0-datasyslab-1`. The artifact keeps the `org.locationtech.jts` Java package names, so application imports do not change.
