...
!!!note
	SedonaSQL provides lots of functions to create a Geometry column, please read [SedonaSQL constructor API](../api/sql/Geometry-Constructors/index.md).
...
!!!note
	Read [SedonaSQL constructor API](../api/sql/Geometry-Constructors/index.md) to learn how to create a Geometry type query window
...
There are lots of other functions can be combined with these queries. Please read [SedonaSQL functions](../api/sql/Overview.md) and [SedonaSQL aggregate functions](../api/sql/Aggregate-Functions/index.md).
