...
class AddressProcessingFunctionsTest extends TestBaseScala with BeforeAndAfterEach {
  ...
  describe("ExpandAddress should return expected normalized forms") {
  ...
  describe("ExpandAddress should return null for null input") {
    val result = sparkSession.sql("SELECT ExpandAddress(NULL) as normalized").collect()
    assert(result.head.get(0) == null)
  }

  describe("ExpandAddress should work when chained with explode") {
  ...
  describe("ParseAddress should return expected label/value pairs") {
    val resultDf = sparkSession
      .sql(
  ...
  describe("ParseAddress should return null for null input") {
    val result = sparkSession.sql("SELECT ParseAddress(NULL) as parsed").collect()
    assert(result.head.get(0) == null)
  }

  describe("ParseAddress should work when chained with explode") {
    val result = sparkSession
  ...
  describe("DataFrame API should return expected normalized forms using ExpandAddress") {
    val result = sparkSession
      .range(1)
  ...
  describe("DataFrame API should return expected label/value pairs using ParseAddress") {
    val result = sparkSession
      .range(1)
  ...
  describe(
    "Codegen should return the same values as non-codegen for ExpandAddress and ParseAddress") {
  ...
  describe(
    "Codegen should return the same values as non-codegen for ExpandAddress and ParseAddress for null input") {
    val expected = sparkSession
      .range(1)
      .select(
  ...
  describe("Codegen should return the same values as non-code-gen case with explode") {
