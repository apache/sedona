...
class TestGeometrySimplify
  ...
  for ((
      ...
      collapse: Boolean,
      epsilon: Double) <- Fixtures.geometriesToSimplify) {
  ...
  object Fixtures {
    ...
    val geometriesToSimplify: TableFor5[String, String, String, Boolean, Double] = Table(
      ...
      (
        ...
        0.0),
      (
        "linestring with 10 epsilon",
        "LINESTRING (0 0, 1 0, 1 1, 0 1, 0 0)",
        "LINESTRING (0 0, 0 0)",
        true,
        10.0),
      (
        "polygon with 10 epsilon",
      ...
      (
        ...
        1.0),
      (
        "another linestring with epsilon 1, 0",
        "LINESTRING (0 0, 50 0.99999, 100 0)",
