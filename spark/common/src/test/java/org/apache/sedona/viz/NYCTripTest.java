...
class NYCTripMapper implements FlatMapFunction<String, Object> {
  ...
  public Iterator call(String line) throws Exception {
    ...
    spatialObject =
        fact.createLineString(coordinatesList.toArray(new Coordinate[coordinatesList.size()]));
...
public class NYCTripTest {
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    inputProp =
        ScatterplotTest.class.getClassLoader().getResourceAsStream("rectangle.test.properties");
    prop.load(inputProp);
    RectangleInputLocation =
        "file://" + ScatterplotTest.class.getClassLoader().getResource("zcta510.csv").getPath();
    ...
    inputProp =
        ScatterplotTest.class.getClassLoader().getResourceAsStream("polygon.test.properties");
    prop.load(inputProp);
    ...
    inputProp =
        ScatterplotTest.class.getClassLoader().getResourceAsStream("linestring.test.properties");
    prop.load(inputProp);
  ...
  public void testLineStringRDDVisualization() throws Exception {
    ...
    PointRDD spatialRDD =
        new PointRDD(sparkContext, PointInputLocation, PointNumPartitions, nycTripPointMapper);
