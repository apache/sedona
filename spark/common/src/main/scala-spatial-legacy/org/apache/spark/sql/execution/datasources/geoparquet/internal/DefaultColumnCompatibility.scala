...
import org.apache.spark.sql.connector.catalog.{CatalogManager, FunctionCatalog}
...
private[internal] object DefaultColumnCompatibility {
  def catalogManager(
    ...
    new CatalogManager(functionCatalog, sessionCatalog)
  }

  def loadFunction(
      sessionCatalog: SessionCatalog,
      identifier: FunctionIdentifier): UnboundFunction = {
    V1Function(sessionCatalog.lookupPersistentFunction(identifier))
  }
}
