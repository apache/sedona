...
public class Example {
  ...
  public static boolean parallelFilterRenderStitch(String outputPath) {
    try {
      ...
      imageGenerator.SaveRasterImageAsLocalFile(
          visualizationOperator.distributedRasterImage, outputPath, ImageType.PNG, 0, 4, 4);
  ...
  public static boolean earthdataVisualization(String outputPath) {
    ...
    try {
      ...
      PointRDD spatialRDD =
          new PointRDD(
              sparkContext, earthdataInputLocation, earthdataNumPartitions, earthdataHDFPoint);
