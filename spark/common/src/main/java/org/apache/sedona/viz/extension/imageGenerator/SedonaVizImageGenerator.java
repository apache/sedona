...
public class SedonaVizImageGenerator extends ImageGenerator {
  ...
  //                    throws Exception
  //            {
  //                SaveRasterImageAsLocalFile(integerImageSerializableWrapperTuple2._2.getImage(),
  // outputPath + "-" + RasterizationUtils.getImageTileName(zoomLevel, partitionOnX, partitionOnY,
  ...
  //                    throws Exception
  //            {
  //                SaveRasterImageAsHadoopFile(integerImageSerializableWrapperTuple2._2.getImage(),
  // outputPath + "-" + RasterizationUtils.getImageTileName(zoomLevel, partitionOnX, partitionOnY,
  // integerImageSerializableWrapperTuple2._1), imageType);
  //            }
  //        });
  ...
  //     */
  //    public boolean SaveRasterImageAsS3File(BufferedImage rasterImage, String regionName, String
  // accessKey, String secretKey, String bucketName, String path, ImageType imageType)
  //            throws IOException
  //    {
  //        logger.info("[Sedona-VizViz][SaveRasterImageAsS3File][Start]");
  //        S3Operator s3Operator = new S3Operator(regionName, accessKey, secretKey);
