...
object Catalog extends AbstractCatalog {
  ...
  override val expressions: Seq[FunctionDescription] = Seq(
    ...
    function[ST_S2Contains](),
    function[ST_S2Contains](),
    function[ST_Intersects](),
    function[ST_S2Intersects](),
    function[ST_S2IntersectsBox](),
    function[ST_Within](),
    function[ST_KNN](),
    function[ST_Covers](),
    ...
    function[ST_S2MaxDistance](),
    function[ST_S2MinimumClearanceLineBetween](),
    function[ST_S2Distance](),
    ...
    function[ST_S2GeogCollFromText](0),
    function[ST_S2GeogCollFromText](0),
    function[ST_Split](),
