...
/**
 * This is taken from [[org.apache.spark.sql.execution.datasources.json.JsonOutputWriter]] with slight
...
class GeoJSONOutputWriter(
  ...
  private[this] val gen = new GeoJSONJacksonGenerator(dataSchema, geometryColumnName, writer, options)
