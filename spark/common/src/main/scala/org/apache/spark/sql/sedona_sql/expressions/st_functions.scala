...
object st_functions {
  ...
  def ST_S2CloestPoint(a: Column, b: Column): Column = wrapExpression[ST_S2CloestPoint](a, b)
  def ST_S2CloestPoint(a: String, b: String): Column = wrapExpression[ST_S2CloestPoint](a, b)
