...
case class NetCdfMetadataPartitionReaderFactory(
  ...
  private def buildReader(partition: RasterInputPartition): PartitionReader[InternalRow] = {
    ...
    def readerForFile(file: PartitionedFile): PartitionReader[InternalRow] = {
      val fileReader =
        new NetCdfMetadataPartitionReader(
    ...
    new NetCdfMetadataConcatPartitionReader(partition.files, readerForFile)
  }
 ...
 */
private class NetCdfMetadataConcatPartitionReader(
