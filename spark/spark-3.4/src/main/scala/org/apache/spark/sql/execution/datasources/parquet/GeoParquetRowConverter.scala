...
private[parquet] class GeoParquetRowConverter(
  ...
  private val dateRebaseFunc =
    GeoDataSourceUtils.creteDateRebaseFuncInRead(datetimeRebaseMode, "Parquet")

  private val timestampRebaseFunc =
    GeoDataSourceUtils.creteTimestampRebaseFuncInRead(datetimeRebaseMode, "Parquet")

  private val int96RebaseFunc =
    GeoDataSourceUtils.creteTimestampRebaseFuncInRead(int96RebaseMode, "Parquet INT96")
