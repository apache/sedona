...
import org.apache.spark.sql.sedona_sql.UDT.{Box2DUDT, Box3DUDT}
import org.apache.spark.sql.types.DataType

class SedonaSqlAstBuilder extends SparkSqlAstBuilder {

  /**
   * Recognize Sedona bounding-box UDT names while leaving GEOMETRY and GEOGRAPHY syntax and SRID
   * validation to Spark's native spatial type parser.
   */
