...
final class DeclaredCoordinateSequence extends CoordinateArraySequence {
  private static final long serialVersionUID = 1L;

  DeclaredCoordinateSequence(Coordinate[] coordinates, int dimension, int measures) {
    super(coordinates, dimension, measures);
  }

  DeclaredCoordinateSequence(int size, int dimension, int measures) {
