...
public class FunctionsApacheSIS {
  ...
  public static Geometry transform(
      ...
      Geometry aoi,
      boolean lenient) {
    org.locationtech.jts.geom.Envelope envelope = aoi.getEnvelopeInternal();
    DefaultGeographicBoundingBox bboxAOI =
        new DefaultGeographicBoundingBox(
