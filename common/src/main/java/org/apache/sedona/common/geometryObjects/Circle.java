...
public class Circle extends Geometry {
  ...
  public Circle(Geometry centerGeometry, Double givenRadius) {
    ...
    // Get the internal radius of the object. We need to make sure that the circle at least should
    // be the minimum circumscribed circle
    ...
    this.radius =
        givenRadius > centerGeometryInternalRadius ? givenRadius : centerGeometryInternalRadius;
    this.MBR =
        new Envelope(
