...
public class SpheroidTest {
  ...
  public void testAngularHeight() throws ParseException {
    Double actual = Spheroid.angularHeight(geomFromWKT("LINESTRING (0 90, 0 -90)", 4326).getEnvelopeInternal());
  ...
  public void testAngularWidth() throws ParseException {
    Double actual = Spheroid.angularWidth(geomFromWKT("LINESTRING (-90 0, 90 0)", 4326).getEnvelopeInternal());
  ...
  public void testAngularWidthAndHeightNearPolesAndAntiMeridian() throws ParseException {
    Envelope env = geomFromWKT("LINESTRING (-179.9999994 -82.42408, -157.330902 -85.0511284)", 4326).getEnvelopeInternal();
