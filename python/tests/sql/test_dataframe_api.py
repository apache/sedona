...
test_configurations = [
    ...
    (stf.ST_ConcaveHull, ("geom",1), "triangle_geom", "", "POLYGON ((0 0, 1 1, 1 0, 0 0))"),
    (stf.ST_ConcaveHull, ("geom",1, True), "triangle_geom", "", "POLYGON ((0 0, 1 1, 1 0, 0 0))"),
