...
class JvmGeoSparkPythonConverter:
    ...
    def translate_spatial_rdd_to_python(self, spatial_rdd):
        return self._jvm.GeoSparkPythonConverter.translateSpatialRDDToPython(spatial_rdd)

    def translate_spatial_pair_rdd_to_python(self, spatial_rdd):
        return self._jvm.GeoSparkPythonConverter.translateSpatialPairRDDToPython(spatial_rdd)

    def translate_spatial_pair_rdd_with_hashset_to_python(self, spatial_rdd):
        return self._jvm.GeoSparkPythonConverter.translateSpatialPairRDDWithHashSetToPython(spatial_rdd)

    def translate_python_rdd_to_java(self, java_rdd):
        return self._jvm.GeoSparkPythonConverter.translatePythonRDDToJava(java_rdd)

    def translate_geometry_seq_to_python(self, geometry_seq) -> List:
        return self._jvm.GeoSparkPythonConverter.translateGeometrySeqToPython(geometry_seq)
...
class GeoSparkPythonConverter:
    ...
    def translate_spatial_rdd_to_python(self, spatial_rdd):
        return self.jvm.GeoSparkPythonConverter.translateSpatialRDDToPython(spatial_rdd)
