...
public class ST_LineFromWKB extends ScalarFunction {
  ...
  public byte[] eval(@DataTypeHint("Bytes") byte[] wkb) throws ParseException {
    return GeometrySerde.serialize(org.apache.sedona.common.Constructors.lineFromWKB(wkb));
  }

  @DataTypeHint("Bytes")
  public byte[] eval(@DataTypeHint("Bytes") byte[] wkb, int srid) throws ParseException {
    return GeometrySerde.serialize(org.apache.sedona.common.Constructors.lineFromWKB(wkb, srid));
  }
}
