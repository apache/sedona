...
public class ST_Point extends ScalarFunction {
  ...
  @DataTypeHint("Bytes")
  public byte[] eval(@DataTypeHint("Double") Double x, @DataTypeHint("Double") Double y) {
    return GeometrySerde.serialize(org.apache.sedona.common.Constructors.point(x, y));
  }
}
