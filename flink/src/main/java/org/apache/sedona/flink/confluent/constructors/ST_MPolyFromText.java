...
public class ST_MPolyFromText extends ScalarFunction {
  ...
  public byte[] eval(@DataTypeHint(value = "String") String wkt, @DataTypeHint("Int") Integer srid)
    ...
    return GeometrySerde.serialize(org.apache.sedona.common.Constructors.mPolyFromText(wkt, srid));
  }

  @DataTypeHint("Bytes")
  public byte[] eval(@DataTypeHint(value = "String") String wkt) throws ParseException {
    return GeometrySerde.serialize(org.apache.sedona.common.Constructors.mPolyFromText(wkt, 0));
  }
}
