...
public class ST_GeomFromGeoJSON extends ScalarFunction {
  ...
  @DataTypeHint("Bytes")
  public byte[] eval(@DataTypeHint("String") String geoJson) throws ParseException {
    return GeometrySerde.serialize(getGeometryByFileData(geoJson, FileDataSplitter.GEOJSON));
  }
}
