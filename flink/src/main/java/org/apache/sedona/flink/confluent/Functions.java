...
public class Functions {
  ...
  public static class ST_ShiftLongitude extends ScalarFunction {
    ...
    public byte[] eval(@DataTypeHint(value = "RAW", bridgedTo = Geometry.class) byte[] ewkb) {
      Geometry geom = GeometrySerde.deserialize(ewkb);
      return GeometrySerde.serialize(org.apache.sedona.common.Functions.shiftLongitude(geom));
    }
  }

  public static class ST_ClosestPoint extends ScalarFunction {

    public byte[] eval(byte[] ewkb, byte[] ewkb2) {
      Geometry geom1 = GeometrySerde.deserialize(ewkb);
      Geometry geom2 = GeometrySerde.deserialize(ewkb2);
      return GeometrySerde.serialize(org.apache.sedona.common.Functions.closestPoint(geom1, geom2));
    }
  }
  ...
  public static class ST_Centroid extends ScalarFunction {
    ...
    public byte[] eval(byte[] ewkb) {
      ...
      Geometry geom = GeometrySerde.deserialize(ewkb);
      return GeometrySerde.serialize(org.apache.sedona.common.Functions.getCentroid(geom));
    }
  }
  ...
  public static class ST_Collect extends ScalarFunction {
    ...
    public byte[] eval(byte[] ewkb, byte[] ewkb2) {
      ...
      return GeometrySerde.serialize(org.apache.sedona.common.Functions.createMultiGeometry(geoms));
    }

    public byte[] eval(@DataTypeHint(inputGroup = InputGroup.ANY) byte[][] ewkb) {
      Geometry[] geoms =
          Arrays.stream(ewkb).map(GeometrySerde::deserialize).toArray(Geometry[]::new);
  ...
  public static class ST_CollectionExtract extends ScalarFunction {
    ...
    public byte[] eval(byte[] ewkb) {
      Geometry geom = GeometrySerde.deserialize(ewkb);
      return GeometrySerde.serialize(org.apache.sedona.common.Functions.collectionExtract(geom));
    }

    public byte[] eval(byte[] ewkb, @DataTypeHint("Integer") Integer geoType) {
      Geometry geom = GeometrySerde.deserialize(ewkb);
      return GeometrySerde.serialize(
          org.apache.sedona.common.Functions.collectionExtract(geom, geoType));
    }
  }

  public static class ST_ConcaveHull extends ScalarFunction {

    public byte[] eval(byte[] ewkb, @DataTypeHint("Double") Double pctConvex) {
      Geometry geom = GeometrySerde.deserialize(ewkb);
      return GeometrySerde.serialize(
          org.apache.sedona.common.Functions.concaveHull(geom, pctConvex, false));
    }
    ...
    public byte[] eval(
      ...
      Geometry geom = GeometrySerde.deserialize(ewkb);
      return GeometrySerde.serialize(
          org.apache.sedona.common.Functions.concaveHull(geom, pctConvex, allowHoles));
    }
  }
  ...
  public static class ST_ConvexHull extends ScalarFunction {
    ...
    public byte[] eval(byte[] ewkb) {
      ...
      Geometry geom = GeometrySerde.deserialize(ewkb);
      return GeometrySerde.serialize(org.apache.sedona.common.Functions.convexHull(geom));
    }
  }
  ...
  public static class ST_Envelope extends ScalarFunction {
    ...
    public byte[] eval(byte[] ewkb) {
      ...
      Geometry geom = GeometrySerde.deserialize(ewkb);
      return GeometrySerde.serialize(org.apache.sedona.common.Functions.envelope(geom));
    }
  }

  public static class ST_Expand extends ScalarFunction {

    public byte[] eval(byte[] ewkb, @DataTypeHint(value = "Double") Double uniformDelta) {
      Geometry geom = GeometrySerde.deserialize(ewkb);
      return GeometrySerde.serialize(org.apache.sedona.common.Functions.expand(geom, uniformDelta));
    }
    ...
    public byte[] eval(
      ...
      Geometry geom = GeometrySerde.deserialize(ewkb);
      return GeometrySerde.serialize(
          org.apache.sedona.common.Functions.expand(geom, deltaX, deltaY));
    }
    ...
    public byte[] eval(
      ...
      Geometry geom = GeometrySerde.deserialize(ewkb);
      return GeometrySerde.serialize(
          org.apache.sedona.common.Functions.expand(geom, deltaX, deltaY, deltaZ));
    }
  }

  public static class ST_Dimension extends ScalarFunction {
    @DataTypeHint("Integer")
    public Integer eval(byte[] ewkb) {
  ...
  public static class ST_Difference extends ScalarFunction {
    ...
    public byte[] eval(byte[] ewkb1, byte[] ewkb2) {
      Geometry geom1 = GeometrySerde.deserialize(ewkb1);
      Geometry geom2 = GeometrySerde.deserialize(ewkb2);
      return GeometrySerde.serialize(org.apache.sedona.common.Functions.difference(geom1, geom2));
    }
  }
  ...
  public static class ST_DistanceSphere extends ScalarFunction {
    ...
    @DataTypeHint("Double")
    public Double eval(byte[] ewkb1, byte[] ewkb2, @DataTypeHint("Double") Double radius) {
      Geometry geom1 = GeometrySerde.deserialize(ewkb1);
      Geometry geom2 = GeometrySerde.deserialize(ewkb2);
  ...
  public static class ST_Dump extends ScalarFunction {
    ...
    public byte[][] eval(byte[] ewkb) {
      Geometry geom1 = GeometrySerde.deserialize(ewkb);
      Geometry[] dumped = org.apache.sedona.common.Functions.dump(geom1);
      return Arrays.stream(dumped).map(GeometrySerde::serialize).toArray(byte[][]::new);
    }
  }
  ...
  public static class ST_DumpPoints extends ScalarFunction {
    ...
    public byte[][] eval(byte[] ewkb) {
      Geometry geom1 = GeometrySerde.deserialize(ewkb);
      Geometry[] dumped = org.apache.sedona.common.Functions.dumpPoints(geom1);
      return Arrays.stream(dumped).map(GeometrySerde::serialize).toArray(byte[][]::new);
    }
  }
  ...
  public static class ST_EndPoint extends ScalarFunction {
    ...
    public byte[] eval(byte[] ewkb) {
      Geometry geom1 = GeometrySerde.deserialize(ewkb);
      return GeometrySerde.serialize(org.apache.sedona.common.Functions.endPoint(geom1));
    }
  }
  ...
  public static class ST_Intersection extends ScalarFunction {
    ...
    public byte[] eval(Object g1, Object g2) {

      Geometry geom1 = (Geometry) g1;
      Geometry geom2 = (Geometry) g2;
      return GeometrySerde.serialize(org.apache.sedona.common.Functions.intersection(geom1, geom2));
    }
  }
  ...
  public static class ST_LineInterpolatePoint extends ScalarFunction {
    ...
    public byte[] eval(byte[] ewkb, @DataTypeHint("Double") Double fraction) {
      Geometry geom = GeometrySerde.deserialize(ewkb);
      return GeometrySerde.serialize(
  ...
  public static class ST_LineLocatePoint extends ScalarFunction {
    @DataTypeHint("Double")
    public Double eval(byte[] ewkb, Object p) {
  ...
  public static class ST_LocateAlong extends ScalarFunction {
    ...
    public byte[] eval(
      ...
      return GeometrySerde.serialize(
          org.apache.sedona.common.Functions.locateAlong(linear, measure, offset));
    }

    public byte[] eval(byte[] ewkb, @DataTypeHint(value = "Double") Double measure) {
      Geometry linear = GeometrySerde.deserialize(ewkb);
      return GeometrySerde.serialize(
          org.apache.sedona.common.Functions.locateAlong(linear, measure));
    }
  }
  ...
  public static class ST_LongestLine extends ScalarFunction {
    ...
    public byte[] eval(Object g1, Object g2) {
      ...
      Geometry geom1 = (Geometry) g1;
      Geometry geom2 = (Geometry) g2;
      return GeometrySerde.serialize(org.apache.sedona.common.Functions.longestLine(geom1, geom2));
    }
  }
  ...
  public static class ST_FlipCoordinates extends ScalarFunction {
    ...
    public byte[] eval(byte[] ewkb) {
      ...
      Geometry geom = GeometrySerde.deserialize(ewkb);
      return GeometrySerde.serialize(org.apache.sedona.common.Functions.flipCoordinates(geom));
    }
  }

  public static class ST_GeoHash extends ScalarFunction {
    @DataTypeHint("String")
    public String eval(Object geometry, Integer precision) {
  ...
  public static class ST_Perimeter extends ScalarFunction {
    ...
    @DataTypeHint(value = "Double")
    public Double eval(byte[] ewkb, Boolean use_spheroid) {
      Geometry geom = GeometrySerde.deserialize(ewkb);
      return org.apache.sedona.common.Functions.perimeter(geom, use_spheroid);
    }

    @DataTypeHint(value = "Double")
    public Double eval(byte[] ewkb, Boolean use_spheroid, boolean lenient) {
      Geometry geom = GeometrySerde.deserialize(ewkb);
  ...
  public static class ST_PointOnSurface extends ScalarFunction {
    ...
    public byte[] eval(byte[] ewkb) {
      ...
      Geometry geom = GeometrySerde.deserialize(ewkb);
      return GeometrySerde.serialize(org.apache.sedona.common.Functions.pointOnSurface(geom));
    }
  }

  public static class ST_ReducePrecision extends ScalarFunction {

    public byte[] eval(byte[] ewkb, @DataTypeHint("Integer") Integer precisionScale) {
      Geometry geom = GeometrySerde.deserialize(ewkb);
      return GeometrySerde.serialize(
          org.apache.sedona.common.Functions.reducePrecision(geom, precisionScale));
    }
  }
  ...
  public static class ST_Reverse extends ScalarFunction {
    ...
    public byte[] eval(byte[] ewkb) {
      ...
      Geometry geom = GeometrySerde.deserialize(ewkb);
      return GeometrySerde.serialize(org.apache.sedona.common.Functions.reverse(geom));
    }
  }

  public static class ST_GeometryN extends ScalarFunction {

    public Geometry eval(byte[] ewkb, int n) {
      Geometry geom = GeometrySerde.deserialize(ewkb);
  ...
  public static class ST_AsHEXEWKB extends ScalarFunction {
    @DataTypeHint("String")
    public String eval(byte[] ewkb, @DataTypeHint("String") String endian) {
      Geometry geom = GeometrySerde.deserialize(ewkb);
  ...
  public static class ST_AsGeoJSON extends ScalarFunction {
    ...
    @DataTypeHint("String")
    public String eval(byte[] ewkb, String type) {
      Geometry geom = GeometrySerde.deserialize(ewkb);
  ...
  public static class ST_SetSRID extends ScalarFunction {
    ...
    public Geometry eval(byte[] ewkb, int srid) {
      Geometry geom = GeometrySerde.deserialize(ewkb);
  ...
  public static class ST_IsValid extends ScalarFunction {
    ...
    @DataTypeHint("Boolean")
    public Boolean eval(byte[] ewkb, @DataTypeHint("Integer") Integer flag) {
      Geometry geom = GeometrySerde.deserialize(ewkb);
  ...
  public static class ST_RemovePoint extends ScalarFunction {
    ...
    public Geometry eval(byte[] ewkb, int offset) {
      Geometry geom = GeometrySerde.deserialize(ewkb);
  ...
  public static class ST_RemoveRepeatedPoints extends ScalarFunction {
    ...
    public Geometry eval(byte[] ewkb, double tolerance) {
      Geometry geom = GeometrySerde.deserialize(ewkb);
  ...
  public static class ST_LineSegments extends ScalarFunction {
    ...
    @DataTypeHint(value = "RAW", bridgedTo = org.locationtech.jts.geom.Geometry[].class)
    public Geometry[] eval(byte[] ewkb, @DataTypeHint(value = "Boolean") Boolean lenient) {
      Geometry geom = GeometrySerde.deserialize(ewkb);
  ...
  public static class ST_MakePolygon extends ScalarFunction {
    ...
    public Geometry eval(byte[] ewkb1, @DataTypeHint(inputGroup = InputGroup.ANY) byte[][] ewkb2) {
      ...
      Geometry[] interiorLinestrings =
          Arrays.stream(ewkb2).map(GeometrySerde::deserialize).toArray(Geometry[]::new);
  ...
  public static class ST_MakeValid extends ScalarFunction {
    ...
    public Geometry eval(byte[] ewkb, @DataTypeHint("Boolean") Boolean keepCollapsed) {
      Geometry geom = GeometrySerde.deserialize(ewkb);
  ...
  public static class ST_MaxDistance extends ScalarFunction {
    @DataTypeHint(value = "Double")
    public Double eval(Object g1, Object g2) {
  ...
  public static class ST_MinimumBoundingCircle extends ScalarFunction {
    ...
    public Geometry eval(byte[] ewkb, @DataTypeHint("Integer") Integer quadrantSegments) {
      Geometry geom = GeometrySerde.deserialize(ewkb);
  ...
  public static class ST_MinimumBoundingRadius extends ScalarFunction {
    ...
    public Pair<Geometry, Double> eval(byte[] ewkb) {
  ...
  public static class ST_S2CellIDs extends ScalarFunction {
    ...
    public Long[] eval(byte[] ewkb, @DataTypeHint("INT") Integer level) {
      Geometry geom = GeometrySerde.deserialize(ewkb);
  ...
  public static class ST_Simplify extends ScalarFunction {
    ...
    public Geometry eval(byte[] ewkb, @DataTypeHint("Double") Double distanceTolerance) {
      Geometry geom = GeometrySerde.deserialize(ewkb);
  ...
  public static class ST_SimplifyPolygonHull extends ScalarFunction {
    ...
    public Geometry eval(byte[] ewkb, @DataTypeHint("Double") Double vertexFactor) {
      Geometry geom = GeometrySerde.deserialize(ewkb);
  ...
  public static class ST_Subdivide extends ScalarFunction {
    @DataTypeHint(value = "RAW", bridgedTo = org.locationtech.jts.geom.Geometry[].class)
    public Geometry[] eval(byte[] ewkb, @DataTypeHint("INT") Integer maxVertices) {
      Geometry geom = GeometrySerde.deserialize(ewkb);
  ...
  public static class ST_GeometricMedian extends ScalarFunction {
    ...
    public Geometry eval(byte[] ewkb) throws Exception {
      Geometry geometry = GeometrySerde.deserialize(ewkb);
      return org.apache.sedona.common.Functions.geometricMedian(geometry);
    }

    public Geometry eval(byte[] ewkb, @DataTypeHint("Double") Double tolerance) throws Exception {
      Geometry geometry = GeometrySerde.deserialize(ewkb);
  ...
  public static class ST_NumPoints extends ScalarFunction {
    ...
    public int eval(byte[] ewkb) throws Exception {
      Geometry geometry = GeometrySerde.deserialize(ewkb);
  ...
  public static class ST_Force4D extends ScalarFunction {
    ...
    public Geometry eval(
        byte[] ewkb, @DataTypeHint("Double") Double zValue, @DataTypeHint("Double") Double mValue) {
      Geometry geometry = GeometrySerde.deserialize(ewkb);
  ...
  public static class ST_GeneratePoints extends ScalarFunction {
    ...
    public Geometry eval(byte[] ewkb, @DataTypeHint(value = "Integer") Integer numPoints) {
      Geometry geom = GeometrySerde.deserialize(ewkb);
  ...
  public static class ST_Translate extends ScalarFunction {
    ...
    public Geometry eval(
        byte[] ewkb, @DataTypeHint("Double") Double deltaX, @DataTypeHint("Double") Double deltaY) {
      Geometry geometry = GeometrySerde.deserialize(ewkb);
  ...
  public static class ST_VoronoiPolygons extends ScalarFunction {
    ...
    public Geometry eval(byte[] ewkb, @DataTypeHint("Double") Double tolerance, Object extend) {
  ...
  public static class ST_HausdorffDistance extends ScalarFunction {
    @DataTypeHint("Double")
    public Double eval(Object g1, Object g2, @DataTypeHint("Double") Double densityFrac)
        throws Exception {
      Geometry geom1 = (Geometry) g1;
      Geometry geom2 = (Geometry) g2;
    ...
    @DataTypeHint("Double")
    public Double eval(Object g1, Object g2) throws Exception {
  ...
  public static class ST_Angle extends ScalarFunction {
    ...
    @DataTypeHint("Double")
    public Double eval(Object p1, Object p2, Object p3, Object p4) {
    ...
    @DataTypeHint("Double")
    public Double eval(Object p1, Object p2, Object p3) {
    ...
    @DataTypeHint("Double")
    public Double eval(Object line1, Object line2) {
  ...
  public static class ST_DelaunayTriangles extends ScalarFunction {
    ...
    public Geometry eval(byte[] ewkb, @DataTypeHint(value = "Double") Double tolerance) {
      Geometry geometry = GeometrySerde.deserialize(ewkb);
  ...
  public static class ST_IsValidReason extends ScalarFunction {
    ...
    @DataTypeHint("String")
    public String eval(byte[] ewkb, @DataTypeHint("Integer") Integer flag) {
      Geometry geom = GeometrySerde.deserialize(ewkb);
  ...
  public static class ST_ScaleGeom extends ScalarFunction {
    ...
    public Geometry eval(byte[] ewkb1, byte[] ewkb2, byte[] ewkb3) {
  ...
  public static class ST_RotateX extends ScalarFunction {
    ...
    public Geometry eval(byte[] ewkb, @DataTypeHint(value = "Double") Double angle) {
      Geometry geom = GeometrySerde.deserialize(ewkb);
  ...
  public static class ST_Rotate extends ScalarFunction {
    ...
    public Geometry eval(byte[] ewkb1, @DataTypeHint(value = "Double") Double angle) {

      Geometry geom1 = GeometrySerde.deserialize(ewkb1);
      return org.apache.sedona.common.Functions.rotate(geom1, angle);
    }

    public Geometry eval(byte[] ewkb1, @DataTypeHint(value = "Double") Double angle, byte[] ewkb2) {
