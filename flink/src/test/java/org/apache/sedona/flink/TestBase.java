...
public class TestBase {
  ...
  static Table createPointTable(int size) {
    return createPointTextTable(size)
        .select(
            call(Constructors.ST_PointFromText.class.getSimpleName(), $(pointColNames[0]))
                .as(pointColNames[0]),
            $(pointColNames[1]),
            $(pointColNames[2]),
            $(pointColNames[3]));
  ...
  static Table createLineStringTable(int size) {
    return createLineStringTextTable(size)
        .select(
            call(Constructors.ST_LineStringFromText.class.getSimpleName(), $(linestringColNames[0]))
  ...
  Table createPolygonTable(int size) {
    return createPolygonTextTable(size)
        .select(
            call(Constructors.ST_PolygonFromText.class.getSimpleName(), $(polygonColNames[0]))
  ...
  Table createMultiPolygonTable(int size) {
    return createMultiPolygonTextTable(size)
        .select(
            call(Constructors.ST_MPolyFromText.class.getSimpleName(), $(multipolygonColNames[0]))
