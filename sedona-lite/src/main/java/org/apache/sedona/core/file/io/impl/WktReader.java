...
package org.apache.sedona.core.file.io.impl;

import org.apache.sedona.core.enums.FileDataSplitter;
import org.apache.sedona.core.file.io.RddReader;
import org.apache.sedona.core.file.parser.FormatMapper;
...
public class WktReader extends RddReader {
  /**
   * Read a SpatialRDD from a org.apache.sedona.core.file.
   *
   * @param sc
   * @param inputPath
   * @param wktColumn The column which contains the wkt string. Start from 0.
   * @param allowInvalidGeometries whether allows topology-invalid geometries exist in the generated
   *     RDD
  ...
  /**
   * Read a SpatialRDD from a string type org.apache.sedona.core.rdd.
   *
