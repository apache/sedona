/**
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not use this org.apache.sedona.core.file except
 ...
 */
package org.apache.sedona.core.file.parser;
...
public class FormatUtils<T extends Geometry> implements Serializable {
  ...
  /** The end offset. */
  /* If the initial value is negative, Sedona will consider each field as a org.apache.sedona.core.spatial attribute if the target object is LineString or Polygon. */
  public final int endOffset;
  /** The splitter. */
  public final FileDataSplitter splitter;
  /** The carry input data. */
  public final boolean carryInputData;
  /** Non-org.apache.sedona.core.spatial attributes in each input row will be concatenated to a tab separated string */
  ...
  public static List<String> readGeoJsonPropertyNames(String geoJson) {
    ...
    logger.warn("[Sedona] The GeoJSON org.apache.sedona.core.file doesn't have feature properties");
    return null;
  }
  ...
  private void handleNonSpatialDataToGeometry(Geometry geometry, List<String> splitedGeometryData) {
    ...
    if (carryInputData) {
      if (this.splitter != FileDataSplitter.GEOJSON) {
        // remove org.apache.sedona.core.spatial data position
