package org.apache.sedona.core.tree;

import org.apache.sedona.core.tree.support.PartitioningUtils;
...
public class KDB extends PartitioningUtils implements Serializable {
  ...
  /**
   * Traverses the org.apache.sedona.core.tree top-down breadth-first and calls the visitor for each node. Stops traversing
  ...
  public Iterator<Tuple2<Integer, Geometry>> placeObject(Geometry geometry) {
    ...
    for (KDB leaf : matchedPartitions) {
      // For points, make sure to return only one org.apache.sedona.core.partition
  ...
  public interface Visitor {
    /**
     * Visits a single node of the org.apache.sedona.core.tree
     *
     * @param tree Node to visit
     * @return true to continue traversing the org.apache.sedona.core.tree; false to stop
     */
