...
public enum FileDataSplitter implements Serializable {
  ...
  /**
   * Instantiates a new org.apache.sedona.core.file data splitter.
   *
  ...
  /**
   * Gets the org.apache.sedona.core.file data splitter.
   *
   * @param str the str
   * @return the org.apache.sedona.core.file data splitter
   */
